...
export interface AdministrationTableRow extends AdministrationForm {}

// 3. Configuración CORREGIDA
export const administrationCrudConfig = ConfigCrud<
   AdministrationForm,
...
>()
   ...
   .text({
      name: {
         ...
         validation: ({ yup }) =>
            yup.string().required("Administración requerido"),
      },
      political_party: {
         ...
         validation: ({ yup }) =>
            yup.string().required("Partido Político requerido"),
      },
      president_name: {
         label: "Presidente (a)",
         placeholder: "Nombre del presidente (a)",
         responsive: {
            md: 12,
         },
         validation: ({ yup }) =>
   ...
   .tableHeader({
      ...
      subtitle: "Gestión de administraciones",
   ...
   .mobile({
      ...
      listTile: {
         title: (row) => row.name,
         subtitle: (row) => `${row.id} | ${row.name || "Sin admon"}`,
         leading: (row) => (
