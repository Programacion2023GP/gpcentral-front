   ...
   return (
      <aside
         style={{
            ...
            // background: `linear-gradient(135deg, ${bgDark} 0%, ${primaryDark} 25%, ${primaryDark} 75%, ${bgDark} 100%)`,
            display: "flex",
         ...
         <div
            ...
            <img
               src={images.logo}
               className="object-cover h-20 animate-pulse"
            />
         </div>
         ...
         <nav
            ...
            <p
               style={{
                  color: hexToRgba(neutral300, 0.5),
         ...
         <div
            ...
            <div
               style={{
                  background: hexToRgba(primaryDark, 0.1),
