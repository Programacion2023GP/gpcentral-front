...
const PortalDropdown = ({
   ...
   return ReactDOM.createPortal(
      <div
         ...
         className="overflow-hidden bg-white border border-gray-200 rounded-lg shadow-xl">
...
>({
   ...
   const tableColumns = useMemo(() => {
      if (crudConfig?.tableColumns) {
         ...
         // console.log("Columnas finales:", cols);
         return cols;
      }
                     ...
                     {crudConfig.tableHeader.icon && (
                        <div className="text-gray-600">
                           {typeof crudConfig.tableHeader.icon === "string" ? (
                              ...
                              <div className="p-3 text-white rounded-xl bg-red-950">
                                 {crudConfig.tableHeader.icon}
                              </div>
                           )}
                        </div>
