...
import { authService } from "../../../library/auth";
...
export const Header = ({ setOpenSidebar, isSidebarOpen }: HeaderProps) => {
   const authData = authService; //useAuthData();
   const authUser = authData.getAuthData();
   ...
   const borderColor = theme.colors.border.button; // 20% opacidad
   const borderLight = `${primaryColor}1A`; // 10% opacidad
   const bgButton = theme.colors.background.button;
   const bgDark = theme.colors.background.fullDark;
      ...
      <header
         style={{
            ...
            background: scrolled
               ...
               : `linear-gradient(135deg, ${bgDark} 0%, ${primaryDark} 25%, ${primaryDark} 75%, ${bgDark} 100%)`,
         ...
         <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <button
               ...
               style={{
                  ...
                  background: isSidebarOpen ? `${bgButton}4D` : "transparent",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
               ...
               <div
                  ...
                  {env.NAME_SYSTEM} |{" "}
                  <small className="font-light">v{env.VERSION}</small>
               </div>
            </div>
         </div>
            ...
            <div ref={dropdownRef} style={{ position: "relative" }}>
               <button
                  ...
                  style={{
                     ...
                     background: dropdownOpen ? `${bgButton}` : "transparent",
                     border: `1px solid ${borderColor}`,
                     borderRadius: theme.radius.md,
                     cursor: "pointer",
                     transition: theme.transitions.DEFAULT,
