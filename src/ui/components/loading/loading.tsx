...
const Spinner = ({
   ...
   // Theme-based colors usando el tema global
   const themeColors = useMemo(
      () => ({
         light: {
            primary: theme.colors.primary.DEFAULT,
            secondary: theme.colors.primary.dark,
            tertiary: theme.colors.neutral[800],
            // background: "bg-white/90",
            background: `${theme.colors.background.fullDark}`,
            text: theme.colors.text.primary,
            // overlay: "bg-white/20",
            overlay: `${theme.colors.background.fullDark}`,
         },
         dark: {
            primary: theme.colors.primary.DEFAULT,
            secondary: theme.colors.primary.dark,
            tertiary: theme.colors.neutral[300],
            background: `${theme.colors.background.fullDark}`,
            text: theme.colors.text.inverse,
            overlay: `${theme.colors.primary.dark}4D`,
         },
      }),
      [],
   );
   ...
   const defaultOverlayColor = overlayColor || theme.colors.primary.DEFAULT;
   ...
   const DefaultSpinner = useMemo(
      () => (
         <motion.svg
            className={`${isExpanded ? expandedSizeClasses[size] : imageSizeClasses[size]} drop-shadow-2xl transition-all duration-1000`}
   ...
   return ReactDOM.createPortal(
      <AnimatePresence>
         <motion.div
            className={`${!fixed ? "fixed" : "absolute"} z-[3000] inset-0 ${
               isExpanded ? theme.colors.primary.dark : defaultOverlayColor
            } ${blurClasses[blurIntensity]} flex flex-col justify-center items-center transition-all duration-1000`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
...
export const AnimatedSpinner = ({
   ...
   const themeColors = {
      ...
      dark: {
         text: theme.colors.text.inverse,
         background: `${theme.colors.primary.dark}66`,
      },
   };
         ...
         <motion.div
            ...
            <motion.div
               ...
               <motion.div
                  className="absolute inset-0 transition-all duration-1000"
                  style={{
                     background: `linear-gradient(135deg, ${theme.colors.primary.DEFAULT}25, ${theme.colors.primary.dark}20, ${theme.colors.neutral[800]}25)`,
                  }}
                  animate={{
               ...
               <div className="relative z-10 w-48 h-1 mt-4 overflow-hidden rounded-full md:w-64 bg-white/20">
                  <motion.div
                     className="h-full transition-all duration-1000 rounded-full"
                     style={{
                        background: `linear-gradient(90deg, ${theme.colors.primary.DEFAULT}, ${theme.colors.primary.dark}, ${theme.colors.neutral[800]})`,
                     }}
                     animate={{
                        x:
                           loadingProgress !== undefined
