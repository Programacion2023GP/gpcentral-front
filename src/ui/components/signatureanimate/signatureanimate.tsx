...
const PenIcon: React.FC<{ size?: number }> = ({ size = 40 }) => (
   <svg width={size} height={size} viewBox="0 0 40 40" fill="none">
      ...
      {/* Barrel */}
      <path
         d="M20 2 L24 8 L22 30 L20 34 L18 30 L16 8 Z"
         fill="url(#pg1)"
         stroke="#7A5510"
         strokeWidth="0.6"
      />
...
const CornerOrnament: React.FC<{ flip?: boolean }> = ({ flip }) => (
   <svg
      ...
      />
      <path
         d="M12 5 Q14 5 14 7 Q14 12 19 12"
         stroke="#C9973A"
         strokeWidth="0.8"
         fill="none"
         opacity="0.5"
...
const StyledSignature: React.FC<StyledSignatureProps> = ({
   ...
   const [inkParticles, setInkParticles] = useState<
      ...
      if (currentIndex < text.length) {
         const t = setTimeout(() => {
            ...
            if (
               ...
               setInkParticles((p) => [
                  ...p.slice(-6),
                  { id, x: cr.left - br.left + 8, y: cr.top - br.top + 28 },
               ]);
               setTimeout(
                  () => setInkParticles((p) => p.filter((pt) => pt.id !== id)),
                  700,
               );
            }
         }, speed);
   ...
   const content = (
      <div
         ...
         {/* ── MODAL CARD ── */}
         <div
            className="relative flex flex-col sig-modal sig-glow"
            style={{
               width,
               maxWidth: "95vw",
               height,
               maxHeight: "95vh",
               background:
                  "linear-gradient(160deg, #FAF6EE 0%, #F5EDD8 40%, #EFE4C6 100%)",
               borderRadius: "4px",
               border: "1px solid rgba(180,140,60,0.4)",
               overflow: "hidden",
               boxShadow:
                  "0 40px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(200,160,70,0.2), inset 0 1px 0 rgba(255,255,255,0.6)",
            }}>
            ...
            <div
               style={{
                  height: "5px",
                  background:
                     "linear-gradient(90deg, transparent, #C9973A 20%, #E8C46A 50%, #C9973A 80%, transparent)",
               }}
            />
            ...
            <div
               style={{
                  ...
                  background:
                     "linear-gradient(180deg, rgba(255,252,240,0.9) 0%, transparent 100%)",
                  display: "flex",
                  alignItems: "center",
               ...
               <div
                  ...
                  <div
                     ...
                     <svg
                        ...
                        fill="none">
                        <path
                           d="M9 1 L11 7 L17 7 L12 11 L14 17 L9 13 L4 17 L6 11 L1 7 L7 7 Z"
                           fill="white"
                           opacity="0.9"
                        />
                     </svg>
                     ...
                     <div
                        ...
                        <div
                           style={{
                              ...
                              borderRadius: "50%",
                              background:
                                 "linear-gradient(135deg, #E8C46A, #8B6220)",
                              flexShrink: 0,
                           }}
                        />
                        <svg
                  ...
                  <div
                     ...
                     <div
                        style={{
                           ...
                           borderRadius: "1px",
                           background:
                              "linear-gradient(90deg, #8B6220, #E8C46A, #C9973A)",
                           width: `${progress * 100}%`,
                  ...
                  <div
                     ...
                     <div
                        style={{
                           ...
                           height: "1px",
                           background:
                              "linear-gradient(90deg, transparent, rgba(180,140,60,0.4) 20%, rgba(180,140,60,0.6) 50%, rgba(180,140,60,0.4) 80%, transparent)",
                        }}
                     />
                     ...
                     <span
                        ...
                        style={{
                           ...
                           display: "inline-block",
                           textShadow:
                              "2px 3px 6px rgba(0,0,0,0.08), 0 1px 2px rgba(0,0,0,0.05)",
                           ...styleExtra,
                        }}>
            ...
            <div
               ...
               <div
                  ...
                  Documento cifrado con tecnología AES-256 · Cumple
                  NOM-151-SCFI-2016
               </div>
               <div
                  style={{
