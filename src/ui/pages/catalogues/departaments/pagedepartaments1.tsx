      ...
      if (data.length > 1) {
         ...
         if (numericKeys.length > 0 && textKeys.length > 0) {
            ...
            const topData = [...data]
               .sort(
                  (a, b) =>
                     (Number(b[numericKey]) || 0) -
                     (Number(a[numericKey]) || 0),
               )
               .slice(0, 8);
            if (topData.length > 1) {
               newCharts.push({
                  ...
                  labels: topData.map((item) =>
                     String(item[categoryKey] ?? "N/D").slice(0, 20),
                  ),
                  datasets: [
                     {
                        label: toLabel(numericKey),
                        data: topData.map(
                           (item) => Number(item[numericKey]) || 0,
                        ),
               ...
               <div
                  ...
                  <button
                     ...
                     style={{
                        ...
                        border: "none",
                        background:
                           activeTab === "table" ? "#9B2242" : "transparent",
                  ...
                  <button
                     ...
                     style={{
                        ...
                        border: "none",
                        background:
                           activeTab === "charts" ? "#9B2242" : "transparent",
