...
type BoxGroup<TForm> = {
   title: string;
   fields: (NestedKeys<TForm> & string)[];
};
...
>() => {
   ...
   const api = {
      fields: <
         ...
         TDateRange extends readonly (NestedKeys<TForm> & string)[] =
            readonly [],
      ...
      >(config: {
         ...
         const methods = {
            text: (
               newConfig: Partial<
                  Record<TText[number], TextConfig<TForm, THooks>>
               >,
            ) => {
            ...
            date: (
               newConfig: Partial<
                  Record<TDate[number], DateConfig<TForm, THooks>>
               >,
            ) => {
            ...
            layout:
               ...
               <
                  TFieldsPerSection extends {
                     [K in TNames[number]]: AllAllowed[] | BoxGroup<TForm>[];
                  },
               >(
